...
function  totalnFrames = generationVEC_movingObjects(nbReps, periode)
...
load('movingShapes_Stimulation_binFile_Reference_reverse.mat');

frs = 1:size(frameReference,1);
...
nomFichier=['movingObjects_reps_' num2str(nbReps) '_timeOn_' num2str(periode) '.vec'];
