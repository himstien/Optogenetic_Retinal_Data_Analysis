...
nomFichier=['oriented_movingBars_reps_' num2str(nbReps) '_timeOn_' num2str(periode) '_jump_' num2str(2.2*jump) 'um.vec'];

% nomFichier=['circular_Bar' num2str(nbReps) '_timeOn_' num2str(periode) '_jump_' num2str(2.2*jump) 'um.vec'];
